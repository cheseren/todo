...
// UserApi({required this.dioClient});
  ...
  Future<TodoModel> updateOneApi(TodoModel? todoModel, String? id) async {
    try {
   ...
   Future<TodoModel> updateDoneApi(TodoModel? todoModel, String? id) async {
    try {
      // print(todoModel!.toJson());
      var response = await dioClient.put(
        "/todo/done/$id",
  ...
  Future<TodoModel> deleteOneApi(String? id) async {
    try {
      var res = await dioClient.delete('/todo/$id');
      // print(res);
